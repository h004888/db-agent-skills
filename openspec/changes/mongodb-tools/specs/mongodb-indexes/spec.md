...
The script SHALL retrieve all indexes defined on a collection.
...
The script SHALL return useful metadata for each index.
...
The script SHALL identify different index types.
