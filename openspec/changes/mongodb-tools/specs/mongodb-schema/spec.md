...
MongoDB is schemaless, so the script SHALL infer schema from sample documents.
...
The script SHALL correctly identify BSON field types.
...
The script SHALL return actual sample documents for reference.
