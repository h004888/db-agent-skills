...
The script SHALL return statistics about the database.
...
The script SHALL return MongoDB server status information.
...
The script SHALL support getting stats for specific collections.
