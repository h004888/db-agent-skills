...
The script SHALL successfully connect to a MongoDB instance and verify connectivity.
...
The script SHALL support MongoDB connection string format.
...
The script SHALL support a quick ping operation to test connectivity.
