...
The script must support MongoDB find queries.
...
The script must support MongoDB aggregation pipelines.
...
The script must support insert, update, and delete operations.
...
The script must support a read-only mode that blocks write operations.
...
The script must serialize BSON types to JSON-compatible formats.
